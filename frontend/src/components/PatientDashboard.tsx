        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">MedTrack Patient</h1>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get medical advice and information</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Add medical documents and images</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Track Symptoms</h3>
                    <p className="text-sm text-gray-600">Monitor your health symptoms</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Manage appointments and reminders</p>
                  </div>
                </button>
              </div>
            </div>
                ...
                {user.symptoms.slice(0, 3).map((symptom) => (
                  <div key={symptom.id} className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{symptom.startDate}</p>
                    </div>
